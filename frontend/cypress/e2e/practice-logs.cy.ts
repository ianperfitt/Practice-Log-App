...
describe("Login Page", () => {
    beforeEach(() => {
      cy.fixture("practice-logs").then(function (data) {
        /* register custom commands. */
        cy.getCommand("/api/v1/practice-logs", data);
        cy.deleteCommand("/api/v1/practice-logs/*");
      });
    ...
    it("should render practice-logs", () => {
      cy.fixture("practice-logs").then(function (data) {
    ...
    it("should add a new log", () => {
      ...
      cy.postCommand("/api/v1/practice-logs", {
        firstName,
        lastName,
        house,
        knownAs,
